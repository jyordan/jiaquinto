<div wire:init="loadLogs">
    @if ($logs)
        <div class="p-6 bg-white dark:bg-gray-800 shadow-md rounded">
            <h2 class="text-xl font-bold mb-4 text-gray-900 dark:text-gray-100">{{ $conversion->company_name }}
                Conversion Logs ({{ $logs->total() }})</h2>
                ...
                <table class="w-full border-collapse border border-gray-300 dark:border-gray-600">
                    <thead class="bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-gray-100">
                        <tr>
                            ...
                            <th class="border border-gray-300 dark:border-gray-600 p-2 text-nowrap">Appointment Date
                            </th>
                            <th class="border border-gray-300 dark:border-gray-600 p-2 text-nowrap">Appointment Status
                            </th>
